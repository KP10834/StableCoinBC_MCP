...
| `/review` | PR 코드 리뷰 후 GitHub에 인라인 코멘트 등록 | [docs](docs/commands/review.md) |
| `/codex:review` | PR 코드 품질/설계/패턴 중점 리뷰 | |
| `/security-review` | PR 보안 취약점 중점 리뷰 (OWASP, 블록체인) | |
...
PR의 변경 코드를 분석하고 GitHub에 인라인 코멘트를 포함한 리뷰를 등록.
...
버그, 보안, 성능, 타입, 스타일을 분류(🔴 CRITICAL / 🟡 WARNING / 🔵 INFO)하여 리뷰 결과를 먼저 보여주고 확인 후 GitHub PR에 등록.
